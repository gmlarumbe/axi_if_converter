...
-- /___/   /\      Filename    : GTHE4_CHANNEL.vhd
-- \   \  /  \
--  \___\/\___\
--
-------------------------------------------------------------------------------
...
architecture GTHE4_CHANNEL_V of GTHE4_CHANNEL is
  component SIP_GTHE4_CHANNEL
    port (
      ...
      COEREG_CLKCTRL       : in std_logic_vector(0 downto 0);
      ...
      RX_SUM_RESLOAD_CTRL  : in std_logic_vector(3 downto 0);
      ...
      TXPI_CFG             : in std_logic_vector(15 downto 0);
      ...
      TX_PI_IBIAS_MID      : in std_logic_vector(1 downto 0);
  ...
  constant MODULE_NAME : string := "GTHE4_CHANNEL";
  ...
  constant A_RXDFEAGCCTRL_BIN : std_logic_vector(1 downto 0) := "01";
  ...
  constant COEREG_CLKCTRL_BIN : std_logic_vector(0 downto 0) := "0";
  ...
  constant LPBK_IND_CTRL0_BIN : std_logic_vector(2 downto 0) := LPBK_IND_CTRL0;
  constant LPBK_IND_CTRL1_BIN : std_logic_vector(2 downto 0) := LPBK_IND_CTRL1;
  constant LPBK_IND_CTRL2_BIN : std_logic_vector(2 downto 0) := LPBK_IND_CTRL2;
  ...
  constant RX_SUM_RESLOAD_CTRL_BIN : std_logic_vector(3 downto 0) := RX_SUM_RESLOAD_CTRL;
  ...
  constant TXPI_CFG_BIN : std_logic_vector(15 downto 0) := TXPI_CFG;
  ...
  constant TX_PI_IBIAS_MID_BIN : std_logic_vector(1 downto 0) := TX_PI_IBIAS_MID;
...
-- Parameter encodings and registers
  ...
  RXDFEAGCCTRL_in(0) <= '0' when (RXDFEAGCCTRL(0) = 'U') else RXDFEAGCCTRL(0); -- rv 0
  RXDFEAGCCTRL_in(1) <= '0' when (RXDFEAGCCTRL(1) = 'U') else RXDFEAGCCTRL(1); -- rv 0
  ...
  RXPHOVRDEN_in <= '0' when (RXPHOVRDEN = 'U') else RXPHOVRDEN; -- rv 0
  ...
  RXQPIEN_in <= '0' when (RXQPIEN = 'U') else RXQPIEN; -- rv 0
  ...
  TXQPIBIASEN_in <= '0' when (TXQPIBIASEN = 'U') else TXQPIBIASEN; -- rv 0
  TXQPIWEAKPUP_in <= '0' when (TXQPIWEAKPUP = 'U') else TXQPIWEAKPUP; -- rv 0
  ...
  begin
    -------- ALIGN_COMMA_DOUBLE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("-130] ALIGN_COMMA_DOUBLE attribute is set to """));
        Write ( Message, string'(ALIGN_COMMA_DOUBLE));
        Write ( Message, string'(""". Legal values for this attribute are "));
        Write ( Message, string'("""FALSE"" or "));
        Write ( Message, string'("""TRUE"". "));
        Write ( Message, string'("Instance "));
        Write ( Message, string'(GTHE4_CHANNEL_V'PATH_NAME));
    ...
    -------- ALIGN_COMMA_WORD check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-132] ALIGN_COMMA_WORD attribute is set to "));
    ...
    -------- ALIGN_MCOMMA_DET check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-133] ALIGN_MCOMMA_DET attribute is set to """));
    ...
    -------- ALIGN_PCOMMA_DET check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-135] ALIGN_PCOMMA_DET attribute is set to """));
    ...
    -------- CBCC_DATA_SOURCE_SEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-273] CBCC_DATA_SOURCE_SEL attribute is set to """));
    ...
    -------- CHAN_BOND_KEEP_ALIGN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-276] CHAN_BOND_KEEP_ALIGN attribute is set to """));
    ...
    -------- CHAN_BOND_MAX_SKEW check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-277] CHAN_BOND_MAX_SKEW attribute is set to "));
    ...
    -------- CHAN_BOND_SEQ_2_USE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-288] CHAN_BOND_SEQ_2_USE attribute is set to """));
    ...
    -------- CHAN_BOND_SEQ_LEN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-289] CHAN_BOND_SEQ_LEN attribute is set to "));
    ...
    -------- CLK_CORRECT_USE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-302] CLK_CORRECT_USE attribute is set to """));
    ...
    -------- CLK_COR_KEEP_IDLE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-303] CLK_COR_KEEP_IDLE attribute is set to """));
    ...
    -------- CLK_COR_MAX_LAT check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-304] CLK_COR_MAX_LAT attribute is set to "));
    ...
    -------- CLK_COR_MIN_LAT check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-305] CLK_COR_MIN_LAT attribute is set to "));
    ...
    -------- CLK_COR_PRECEDENCE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-306] CLK_COR_PRECEDENCE attribute is set to """));
    ...
    -------- CLK_COR_REPEAT_WAIT check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-307] CLK_COR_REPEAT_WAIT attribute is set to "));
    ...
    -------- CLK_COR_SEQ_2_USE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-318] CLK_COR_SEQ_2_USE attribute is set to """));
    ...
    -------- CLK_COR_SEQ_LEN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-319] CLK_COR_SEQ_LEN attribute is set to "));
    ...
    -------- CPLL_FBDIV check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-325] CPLL_FBDIV attribute is set to "));
    ...
    -------- CPLL_FBDIV_45 check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-326] CPLL_FBDIV_45 attribute is set to "));
    ...
    -------- CPLL_REFCLK_DIV check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-329] CPLL_REFCLK_DIV attribute is set to "));
    ...
    -------- DDI_REALIGN_WAIT check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-346] DDI_REALIGN_WAIT attribute is set to "));
    ...
    -------- DEC_MCOMMA_DETECT check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-347] DEC_MCOMMA_DETECT attribute is set to """));
    ...
    -------- DEC_PCOMMA_DETECT check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-348] DEC_PCOMMA_DETECT attribute is set to """));
    ...
    -------- DEC_VALID_COMMA_ONLY check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-349] DEC_VALID_COMMA_ONLY attribute is set to """));
    ...
    -------- ES_ERRDET_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-355] ES_ERRDET_EN attribute is set to """));
    ...
    -------- ES_EYE_SCAN_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-356] ES_EYE_SCAN_EN attribute is set to """));
    ...
    -------- FTS_LANE_DESKEW_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-392] FTS_LANE_DESKEW_EN attribute is set to """));
    ...
    -------- PCI3_AUTO_REALIGN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-410] PCI3_AUTO_REALIGN attribute is set to """));
    ...
    -------- PCS_PCIE_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-432] PCS_PCIE_EN attribute is set to """));
    ...
    -------- PREIQ_FREQ_BST check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-437] PREIQ_FREQ_BST attribute is set to "));
    ...
    -------- RXBUF_ADDR_MODE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-446] RXBUF_ADDR_MODE attribute is set to """));
    ...
    -------- RXBUF_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-449] RXBUF_EN attribute is set to """));
    ...
    -------- RXBUF_RESET_ON_CB_CHANGE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-450] RXBUF_RESET_ON_CB_CHANGE attribute is set to """));
    ...
    -------- RXBUF_RESET_ON_COMMAALIGN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-451] RXBUF_RESET_ON_COMMAALIGN attribute is set to """));
    ...
    -------- RXBUF_RESET_ON_EIDLE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-452] RXBUF_RESET_ON_EIDLE attribute is set to """));
    ...
    -------- RXBUF_RESET_ON_RATE_CHANGE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-453] RXBUF_RESET_ON_RATE_CHANGE attribute is set to """));
    ...
    -------- RXBUF_THRESH_OVFLW check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-454] RXBUF_THRESH_OVFLW attribute is set to "));
    ...
    -------- RXBUF_THRESH_OVRD check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-455] RXBUF_THRESH_OVRD attribute is set to """));
    ...
    -------- RXBUF_THRESH_UNDFLW check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-456] RXBUF_THRESH_UNDFLW attribute is set to "));
    ...
    -------- RXELECIDLE_CFG check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-544] RXELECIDLE_CFG attribute is set to """));
    ...
    -------- RXGBOX_FIFO_INIT_RD_ADDR check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-545] RXGBOX_FIFO_INIT_RD_ADDR attribute is set to "));
    ...
    -------- RXGEARBOX_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-546] RXGEARBOX_EN attribute is set to """));
    ...
    -------- RXOOB_CLK_CFG check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-555] RXOOB_CLK_CFG attribute is set to """));
    ...
    -------- RXOUT_DIV check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-557] RXOUT_DIV attribute is set to "));
    ...
    -------- RXPMACLK_SEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-571] RXPMACLK_SEL attribute is set to """));
    ...
    -------- RXPRBS_LINKACQ_CNT check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-574] RXPRBS_LINKACQ_CNT attribute is set to "));
    ...
    -------- RXSLIDE_AUTO_WAIT check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-576] RXSLIDE_AUTO_WAIT attribute is set to "));
    ...
    -------- RXSLIDE_MODE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-577] RXSLIDE_MODE attribute is set to """));
    ...
    -------- RX_CLK25_DIV check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-585] RX_CLK25_DIV attribute is set to "));
    ...
    -------- RX_CM_SEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-590] RX_CM_SEL attribute is set to "));
    ...
    -------- RX_CM_TRIM check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-591] RX_CM_TRIM attribute is set to "));
    ...
    -------- RX_DATA_WIDTH check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-593] RX_DATA_WIDTH attribute is set to "));
    ...
    -------- RX_DEFER_RESET_BUF_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-595] RX_DEFER_RESET_BUF_EN attribute is set to """));
    ...
    -------- RX_DFELPM_CFG0 check
      if((xil_attr_test) or
         ((RX_DFELPM_CFG0 /= 0) and 
          ...
          (RX_DFELPM_CFG0 /= 7) and 
          (RX_DFELPM_CFG0 /= 8) and 
          (RX_DFELPM_CFG0 /= 9) and 
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-598] RX_DFELPM_CFG0 attribute is set to "));
    ...
    -------- RX_DFE_AGC_CFG1 check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-602] RX_DFE_AGC_CFG1 attribute is set to "));
    ...
    -------- RX_DFE_KL_LPM_KH_CFG0 check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-603] RX_DFE_KL_LPM_KH_CFG0 attribute is set to "));
    ...
    -------- RX_DFE_KL_LPM_KH_CFG1 check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-604] RX_DFE_KL_LPM_KH_CFG1 attribute is set to "));
    ...
    -------- RX_DFE_KL_LPM_KL_CFG1 check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-606] RX_DFE_KL_LPM_KL_CFG1 attribute is set to "));
    ...
    -------- RX_DISPERR_SEQ_MATCH check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-608] RX_DISPERR_SEQ_MATCH attribute is set to """));
    ...
    -------- RX_INT_DATAWIDTH check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-619] RX_INT_DATAWIDTH attribute is set to "));
    ...
    -------- RX_PROGDIV_CFG check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-622] RX_PROGDIV_CFG attribute is set to "));
    ...
    -------- RX_SIG_VALID_DLY check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-627] RX_SIG_VALID_DLY attribute is set to "));
    ...
    -------- RX_XCLK_SEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-640] RX_XCLK_SEL attribute is set to """));
    ...
    -------- SATA_CPLL_CFG check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-646] SATA_CPLL_CFG attribute is set to """));
    ...
    -------- SHOW_REALIGN_COMMA check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-648] SHOW_REALIGN_COMMA attribute is set to """));
    ...
    -------- SIM_DEVICE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-649] SIM_DEVICE attribute is set to """));
    ...
    -------- SIM_MODE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-650] SIM_MODE attribute is set to """));
    ...
    -------- SIM_RECEIVER_DETECT_PASS check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-651] SIM_RECEIVER_DETECT_PASS attribute is set to """));
    ...
    -------- SIM_RESET_SPEEDUP check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-652] SIM_RESET_SPEEDUP attribute is set to """));
    ...
    -------- SIM_TX_EIDLE_DRIVE_LEVEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-653] SIM_TX_EIDLE_DRIVE_LEVEL attribute is set to """));
    ...
    -------- TXBUF_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-662] TXBUF_EN attribute is set to """));
    ...
    -------- TXBUF_RESET_ON_RATE_CHANGE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-663] TXBUF_RESET_ON_RATE_CHANGE attribute is set to """));
    ...
    -------- TXFIFO_ADDR_CFG check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-667] TXFIFO_ADDR_CFG attribute is set to """));
    ...
    -------- TXGBOX_FIFO_INIT_RD_ADDR check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-668] TXGBOX_FIFO_INIT_RD_ADDR attribute is set to "));
    ...
    -------- TXGEARBOX_EN check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-669] TXGEARBOX_EN attribute is set to """));
    ...
    -------- TXOUT_DIV check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-671] TXOUT_DIV attribute is set to "));
    ...
    -------- TXPI_PPMCLK_SEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-689] TXPI_PPMCLK_SEL attribute is set to """));
    ...
    -------- TX_CLK25_DIV check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-698] TX_CLK25_DIV attribute is set to "));
    ...
    -------- TX_DATA_WIDTH check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-700] TX_DATA_WIDTH attribute is set to "));
    ...
    -------- TX_DRIVE_MODE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-707] TX_DRIVE_MODE attribute is set to """));
    ...
    -------- TX_DRVMUX_CTRL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-708] TX_DRVMUX_CTRL attribute is set to "));
    ...
    -------- TX_INT_DATAWIDTH check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-714] TX_INT_DATAWIDTH attribute is set to "));
    ...
    -------- TX_LOOPBACK_DRIVE_HIZ check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-715] TX_LOOPBACK_DRIVE_HIZ attribute is set to """));
    ...
    -------- TX_PI_BIASSET check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-730] TX_PI_BIASSET attribute is set to "));
    ...
    -------- TX_PREDRV_CTRL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-735] TX_PREDRV_CTRL attribute is set to "));
    ...
    -------- TX_PROGCLK_SEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-736] TX_PROGCLK_SEL attribute is set to """));
    ...
    -------- TX_PROGDIV_CFG check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-737] TX_PROGDIV_CFG attribute is set to "));
    ...
    -------- TX_RXDETECT_REF check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-741] TX_RXDETECT_REF attribute is set to "));
    ...
    -------- TX_XCLK_SEL check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-756] TX_XCLK_SEL attribute is set to """));
    ...
    -------- USB_PING_SATA_MAX_INIT check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-774] USB_PING_SATA_MAX_INIT attribute is set to "));
    ...
    -------- USB_PING_SATA_MIN_INIT check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-775] USB_PING_SATA_MIN_INIT attribute is set to "));
    ...
    -------- USB_POLL_SATA_MAX_BURST check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-776] USB_POLL_SATA_MAX_BURST attribute is set to "));
    ...
    -------- USB_POLL_SATA_MIN_BURST check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-777] USB_POLL_SATA_MIN_BURST attribute is set to "));
    ...
    -------- USB_U1_SATA_MAX_WAKE check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-781] USB_U1_SATA_MAX_WAKE attribute is set to "));
    ...
    -------- USB_U1_SATA_MIN_WAKE check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-782] USB_U1_SATA_MIN_WAKE attribute is set to "));
    ...
    -------- USB_U2_SAS_MAX_COM check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-783] USB_U2_SAS_MAX_COM attribute is set to "));
    ...
    -------- USB_U2_SAS_MIN_COM check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-784] USB_U2_SAS_MIN_COM attribute is set to "));
    ...
    if  (attr_err) then
      ...
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-198] Attribute Error(s) encountered. "));
      Write ( Message, string'("Instance "));
      Write ( Message, string'(GTHE4_CHANNEL_V'PATH_NAME));
      assert FALSE
      report Message.all
    ...
    SIP_GTHE4_CHANNEL_INST : SIP_GTHE4_CHANNEL
      port map (
        ...
        COEREG_CLKCTRL       => COEREG_CLKCTRL_BIN,
        ...
        RX_SUM_RESLOAD_CTRL  => RX_SUM_RESLOAD_CTRL_BIN,
        ...
        TX_PI_IBIAS_MID      => TX_PI_IBIAS_MID_BIN,
