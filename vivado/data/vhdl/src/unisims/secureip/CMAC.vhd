...
architecture CMAC_V of CMAC is
  ...
  -- Parameter encodings and registers
    ...
    signal RX_ENAOUT0_out : std_logic;
    signal RX_ENAOUT1_out : std_logic;
    signal RX_ENAOUT2_out : std_logic;
    signal RX_ENAOUT3_out : std_logic;
    signal RX_EOPOUT0_out : std_logic;
    signal RX_EOPOUT1_out : std_logic;
    signal RX_EOPOUT2_out : std_logic;
    signal RX_EOPOUT3_out : std_logic;
    signal RX_ERROUT0_out : std_logic;
    signal RX_ERROUT1_out : std_logic;
    signal RX_ERROUT2_out : std_logic;
    signal RX_ERROUT3_out : std_logic;
    ...
    signal RX_SOPOUT0_out : std_logic;
    signal RX_SOPOUT1_out : std_logic;
    signal RX_SOPOUT2_out : std_logic;
    signal RX_SOPOUT3_out : std_logic;
    signal SCAN_OUT_CMAC_out : std_logic_vector(181 downto 0);
    signal SCAN_OUT_DRPCTRL_out : std_logic_vector(12 downto 0);
    signal STAT_RX_ALIGNED_ERR_out : std_logic;
    signal STAT_RX_ALIGNED_out : std_logic;
    signal STAT_RX_BAD_CODE_out : std_logic_vector(6 downto 0);
    signal STAT_RX_BAD_FCS_out : std_logic_vector(3 downto 0);
    signal STAT_RX_BAD_PREAMBLE_out : std_logic;
    signal STAT_RX_BAD_SFD_out : std_logic;
    signal STAT_RX_BIP_ERR_0_out : std_logic;
    signal STAT_RX_BIP_ERR_10_out : std_logic;
    signal STAT_RX_BIP_ERR_11_out : std_logic;
    signal STAT_RX_BIP_ERR_12_out : std_logic;
    signal STAT_RX_BIP_ERR_13_out : std_logic;
    signal STAT_RX_BIP_ERR_14_out : std_logic;
    signal STAT_RX_BIP_ERR_15_out : std_logic;
    signal STAT_RX_BIP_ERR_16_out : std_logic;
    signal STAT_RX_BIP_ERR_17_out : std_logic;
    signal STAT_RX_BIP_ERR_18_out : std_logic;
    signal STAT_RX_BIP_ERR_19_out : std_logic;
    signal STAT_RX_BIP_ERR_1_out : std_logic;
    signal STAT_RX_BIP_ERR_2_out : std_logic;
    signal STAT_RX_BIP_ERR_3_out : std_logic;
    signal STAT_RX_BIP_ERR_4_out : std_logic;
    signal STAT_RX_BIP_ERR_5_out : std_logic;
    signal STAT_RX_BIP_ERR_6_out : std_logic;
    signal STAT_RX_BIP_ERR_7_out : std_logic;
    signal STAT_RX_BIP_ERR_8_out : std_logic;
    signal STAT_RX_BIP_ERR_9_out : std_logic;
    signal STAT_RX_BLOCK_LOCK_out : std_logic_vector(19 downto 0);
    signal STAT_RX_BROADCAST_out : std_logic;
    ...
    signal STAT_RX_FRAMING_ERR_VALID_0_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_10_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_11_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_12_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_13_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_14_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_15_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_16_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_17_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_18_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_19_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_1_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_2_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_3_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_4_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_5_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_6_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_7_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_8_out : std_logic;
    signal STAT_RX_FRAMING_ERR_VALID_9_out : std_logic;
    signal STAT_RX_GOT_SIGNAL_OS_out : std_logic;
    signal STAT_RX_HI_BER_out : std_logic;
    signal STAT_RX_INRANGEERR_out : std_logic;
    signal STAT_RX_INTERNAL_LOCAL_FAULT_out : std_logic;
    signal STAT_RX_JABBER_out : std_logic;
    signal STAT_RX_LANE0_VLM_BIP7_VALID_out : std_logic;
    signal STAT_RX_LANE0_VLM_BIP7_out : std_logic_vector(7 downto 0);
    signal STAT_RX_LOCAL_FAULT_out : std_logic;
    ...
    signal STAT_RX_MISALIGNED_out : std_logic;
    signal STAT_RX_MULTICAST_out : std_logic;
    signal STAT_RX_OVERSIZE_out : std_logic;
    signal STAT_RX_PACKET_1024_1518_BYTES_out : std_logic;
    signal STAT_RX_PACKET_128_255_BYTES_out : std_logic;
    signal STAT_RX_PACKET_1519_1522_BYTES_out : std_logic;
    signal STAT_RX_PACKET_1523_1548_BYTES_out : std_logic;
    signal STAT_RX_PACKET_1549_2047_BYTES_out : std_logic;
    signal STAT_RX_PACKET_2048_4095_BYTES_out : std_logic;
    signal STAT_RX_PACKET_256_511_BYTES_out : std_logic;
    signal STAT_RX_PACKET_4096_8191_BYTES_out : std_logic;
    signal STAT_RX_PACKET_512_1023_BYTES_out : std_logic;
    signal STAT_RX_PACKET_64_BYTES_out : std_logic;
    signal STAT_RX_PACKET_65_127_BYTES_out : std_logic;
    signal STAT_RX_PACKET_8192_9215_BYTES_out : std_logic;
    signal STAT_RX_PACKET_BAD_FCS_out : std_logic;
    signal STAT_RX_PACKET_LARGE_out : std_logic;
    ...
    signal STAT_RX_PAUSE_out : std_logic;
    signal STAT_RX_RECEIVED_LOCAL_FAULT_out : std_logic;
    signal STAT_RX_REMOTE_FAULT_out : std_logic;
    signal STAT_RX_STATUS_out : std_logic;
    ...
    signal STAT_RX_TOOLONG_out : std_logic;
    ...
    signal STAT_RX_TOTAL_GOOD_PACKETS_out : std_logic;
    signal STAT_RX_TOTAL_PACKETS_out : std_logic_vector(3 downto 0);
    signal STAT_RX_TRUNCATED_out : std_logic;
    signal STAT_RX_UNDERSIZE_out : std_logic_vector(3 downto 0);
    signal STAT_RX_UNICAST_out : std_logic;
    signal STAT_RX_USER_PAUSE_out : std_logic;
    signal STAT_RX_VLAN_out : std_logic;
    ...
    signal STAT_TX_BAD_FCS_out : std_logic;
    signal STAT_TX_BROADCAST_out : std_logic;
    signal STAT_TX_FRAME_ERROR_out : std_logic;
    signal STAT_TX_LOCAL_FAULT_out : std_logic;
    signal STAT_TX_MULTICAST_out : std_logic;
    signal STAT_TX_PACKET_1024_1518_BYTES_out : std_logic;
    signal STAT_TX_PACKET_128_255_BYTES_out : std_logic;
    signal STAT_TX_PACKET_1519_1522_BYTES_out : std_logic;
    signal STAT_TX_PACKET_1523_1548_BYTES_out : std_logic;
    signal STAT_TX_PACKET_1549_2047_BYTES_out : std_logic;
    signal STAT_TX_PACKET_2048_4095_BYTES_out : std_logic;
    signal STAT_TX_PACKET_256_511_BYTES_out : std_logic;
    signal STAT_TX_PACKET_4096_8191_BYTES_out : std_logic;
    signal STAT_TX_PACKET_512_1023_BYTES_out : std_logic;
    signal STAT_TX_PACKET_64_BYTES_out : std_logic;
    signal STAT_TX_PACKET_65_127_BYTES_out : std_logic;
    signal STAT_TX_PACKET_8192_9215_BYTES_out : std_logic;
    signal STAT_TX_PACKET_LARGE_out : std_logic;
    signal STAT_TX_PACKET_SMALL_out : std_logic;
    signal STAT_TX_PAUSE_VALID_out : std_logic_vector(8 downto 0);
    signal STAT_TX_PAUSE_out : std_logic;
    signal STAT_TX_PTP_FIFO_READ_ERROR_out : std_logic;
    signal STAT_TX_PTP_FIFO_WRITE_ERROR_out : std_logic;
    ...
    signal STAT_TX_TOTAL_GOOD_PACKETS_out : std_logic;
    signal STAT_TX_TOTAL_PACKETS_out : std_logic;
    signal STAT_TX_UNICAST_out : std_logic;
    signal STAT_TX_USER_PAUSE_out : std_logic;
    signal STAT_TX_VLAN_out : std_logic;
    signal TX_OVFOUT_out : std_logic;
    ...
    signal TX_PTP_TSTAMP_VALID_OUT_out : std_logic;
    signal TX_RDYOUT_out : std_logic;
    ...
    signal TX_UNFOUT_out : std_logic;
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-179] SIM_VERSION attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-180] TEST_MODE_PIN_CHAR attribute is set to """));
    ...
    if  (attr_err) then
      ...
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-181] Attribute Error(s) encountered. "));
      Write ( Message, string'("Instance "));
      Write ( Message, string'(CMAC_V'INSTANCE_NAME));
      assert FALSE
      report Message.all
  ...
  ES2_CMAC_inst : if (SIM_VERSION = "2.0") generate
    CMAC_INST : SIP_CMAC_ES2
      port map (
    ...
    end generate ES2_CMAC_inst;

    ES1_CMAC_inst : if (SIM_VERSION = "1.0") generate
