...
--        SIM_MODE : string := "FAST";
  ...
  END conv_string_to_slv;
    ...
    constant AEN_SDMDATA0_BIN : std_logic_vector(0 downto 0) := "0";
    constant AEN_SDMDATA1_BIN : std_logic_vector(0 downto 0) := "0";
    constant AEN_SDMRESET0_BIN : std_logic_vector(0 downto 0) := "0";
    constant AEN_SDMRESET1_BIN : std_logic_vector(0 downto 0) := "0";
    constant AEN_SDMWIDTH0_BIN : std_logic_vector(0 downto 0) := "0";
    constant AEN_SDMWIDTH1_BIN : std_logic_vector(0 downto 0) := "0";
    ...
    constant A_SDM0DATA1_0_BIN : std_logic_vector(15 downto 0) := "0000000000000000";
    constant A_SDM0DATA1_1_BIN : std_logic_vector(8 downto 0) := "000000000";
    constant A_SDM1DATA1_0_BIN : std_logic_vector(15 downto 0) := A_SDM1DATA1_0;
    constant A_SDM1DATA1_1_BIN : std_logic_vector(8 downto 0) := A_SDM1DATA1_1;
    constant A_SDMRESET0_BIN : std_logic_vector(0 downto 0) := "0";
    constant A_SDMRESET1_BIN : std_logic_vector(0 downto 0) := "0";
  ...
  -- Parameter encodings and registers
    ...
    SDM0FINALOUT <= SDM0FINALOUT_out after OUT_DELAY;
    SDM0TESTDATA <= SDM0TESTDATA_out after OUT_DELAY;
    SDM1FINALOUT <= SDM1FINALOUT_out after OUT_DELAY;
    SDM1TESTDATA <= SDM1TESTDATA_out after OUT_DELAY;
    ...
    RCALENB_in <= RCALENB;
    SDM0DATA_in(0) <= '0' when (SDM0DATA(0) = 'Z') else SDM0DATA(0); -- rv 0
    SDM0DATA_in(1) <= '0' when (SDM0DATA(1) = 'Z') else SDM0DATA(1); -- rv 0
    SDM0DATA_in(10) <= '0' when (SDM0DATA(10) = 'Z') else SDM0DATA(10); -- rv 0
    SDM0DATA_in(11) <= '0' when (SDM0DATA(11) = 'Z') else SDM0DATA(11); -- rv 0
    SDM0DATA_in(12) <= '0' when (SDM0DATA(12) = 'Z') else SDM0DATA(12); -- rv 0
    SDM0DATA_in(13) <= '0' when (SDM0DATA(13) = 'Z') else SDM0DATA(13); -- rv 0
    SDM0DATA_in(14) <= '0' when (SDM0DATA(14) = 'Z') else SDM0DATA(14); -- rv 0
    SDM0DATA_in(15) <= '0' when (SDM0DATA(15) = 'Z') else SDM0DATA(15); -- rv 0
    SDM0DATA_in(16) <= '0' when (SDM0DATA(16) = 'Z') else SDM0DATA(16); -- rv 0
    SDM0DATA_in(17) <= '0' when (SDM0DATA(17) = 'Z') else SDM0DATA(17); -- rv 0
    SDM0DATA_in(18) <= '0' when (SDM0DATA(18) = 'Z') else SDM0DATA(18); -- rv 0
    SDM0DATA_in(19) <= '0' when (SDM0DATA(19) = 'Z') else SDM0DATA(19); -- rv 0
    SDM0DATA_in(2) <= '0' when (SDM0DATA(2) = 'Z') else SDM0DATA(2); -- rv 0
    SDM0DATA_in(20) <= '0' when (SDM0DATA(20) = 'Z') else SDM0DATA(20); -- rv 0
    SDM0DATA_in(21) <= '0' when (SDM0DATA(21) = 'Z') else SDM0DATA(21); -- rv 0
    SDM0DATA_in(22) <= '0' when (SDM0DATA(22) = 'Z') else SDM0DATA(22); -- rv 0
    SDM0DATA_in(23) <= '0' when (SDM0DATA(23) = 'Z') else SDM0DATA(23); -- rv 0
    SDM0DATA_in(24) <= '0' when (SDM0DATA(24) = 'Z') else SDM0DATA(24); -- rv 0
    SDM0DATA_in(3) <= '0' when (SDM0DATA(3) = 'Z') else SDM0DATA(3); -- rv 0
    SDM0DATA_in(4) <= '0' when (SDM0DATA(4) = 'Z') else SDM0DATA(4); -- rv 0
    SDM0DATA_in(5) <= '0' when (SDM0DATA(5) = 'Z') else SDM0DATA(5); -- rv 0
    SDM0DATA_in(6) <= '0' when (SDM0DATA(6) = 'Z') else SDM0DATA(6); -- rv 0
    SDM0DATA_in(7) <= '0' when (SDM0DATA(7) = 'Z') else SDM0DATA(7); -- rv 0
    SDM0DATA_in(8) <= '0' when (SDM0DATA(8) = 'Z') else SDM0DATA(8); -- rv 0
    SDM0DATA_in(9) <= '0' when (SDM0DATA(9) = 'Z') else SDM0DATA(9); -- rv 0
    SDM0RESET_in <= '0' when (SDM0RESET = 'Z') else SDM0RESET; -- rv 0
    SDM0WIDTH_in(0) <= '0' when (SDM0WIDTH(0) = 'Z') else SDM0WIDTH(0); -- rv 0
    SDM0WIDTH_in(1) <= '0' when (SDM0WIDTH(1) = 'Z') else SDM0WIDTH(1); -- rv 0
    SDM1DATA_in(0) <= '0' when (SDM1DATA(0) = 'Z') else SDM1DATA(0); -- rv 0
    SDM1DATA_in(1) <= '0' when (SDM1DATA(1) = 'Z') else SDM1DATA(1); -- rv 0
    SDM1DATA_in(10) <= '0' when (SDM1DATA(10) = 'Z') else SDM1DATA(10); -- rv 0
    SDM1DATA_in(11) <= '0' when (SDM1DATA(11) = 'Z') else SDM1DATA(11); -- rv 0
    SDM1DATA_in(12) <= '0' when (SDM1DATA(12) = 'Z') else SDM1DATA(12); -- rv 0
    SDM1DATA_in(13) <= '0' when (SDM1DATA(13) = 'Z') else SDM1DATA(13); -- rv 0
    SDM1DATA_in(14) <= '0' when (SDM1DATA(14) = 'Z') else SDM1DATA(14); -- rv 0
    SDM1DATA_in(15) <= '0' when (SDM1DATA(15) = 'Z') else SDM1DATA(15); -- rv 0
    SDM1DATA_in(16) <= '0' when (SDM1DATA(16) = 'Z') else SDM1DATA(16); -- rv 0
    SDM1DATA_in(17) <= '0' when (SDM1DATA(17) = 'Z') else SDM1DATA(17); -- rv 0
    SDM1DATA_in(18) <= '0' when (SDM1DATA(18) = 'Z') else SDM1DATA(18); -- rv 0
    SDM1DATA_in(19) <= '0' when (SDM1DATA(19) = 'Z') else SDM1DATA(19); -- rv 0
    SDM1DATA_in(2) <= '0' when (SDM1DATA(2) = 'Z') else SDM1DATA(2); -- rv 0
    SDM1DATA_in(20) <= '0' when (SDM1DATA(20) = 'Z') else SDM1DATA(20); -- rv 0
    SDM1DATA_in(21) <= '0' when (SDM1DATA(21) = 'Z') else SDM1DATA(21); -- rv 0
    SDM1DATA_in(22) <= '0' when (SDM1DATA(22) = 'Z') else SDM1DATA(22); -- rv 0
    SDM1DATA_in(23) <= '0' when (SDM1DATA(23) = 'Z') else SDM1DATA(23); -- rv 0
    SDM1DATA_in(24) <= '0' when (SDM1DATA(24) = 'Z') else SDM1DATA(24); -- rv 0
    SDM1DATA_in(3) <= '0' when (SDM1DATA(3) = 'Z') else SDM1DATA(3); -- rv 0
    SDM1DATA_in(4) <= '0' when (SDM1DATA(4) = 'Z') else SDM1DATA(4); -- rv 0
    SDM1DATA_in(5) <= '0' when (SDM1DATA(5) = 'Z') else SDM1DATA(5); -- rv 0
    SDM1DATA_in(6) <= '0' when (SDM1DATA(6) = 'Z') else SDM1DATA(6); -- rv 0
    SDM1DATA_in(7) <= '0' when (SDM1DATA(7) = 'Z') else SDM1DATA(7); -- rv 0
    SDM1DATA_in(8) <= '0' when (SDM1DATA(8) = 'Z') else SDM1DATA(8); -- rv 0
    SDM1DATA_in(9) <= '0' when (SDM1DATA(9) = 'Z') else SDM1DATA(9); -- rv 0
    SDM1RESET_in <= '0' when (SDM1RESET = 'Z') else SDM1RESET; -- rv 0
    SDM1WIDTH_in(0) <= '0' when (SDM1WIDTH(0) = 'Z') else SDM1WIDTH(0); -- rv 0
    SDM1WIDTH_in(1) <= '0' when (SDM1WIDTH(1) = 'Z') else SDM1WIDTH(1); -- rv 0
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-218] SIM_MODE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-219] SIM_RESET_SPEEDUP attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-220] SIM_VERSION attribute is set to "));
    ...
    if  (attr_err) then
      ...
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-173] Attribute Error(s) encountered. "));
      Write ( Message, string'("Instance "));
      Write ( Message, string'(GTYE3_COMMON_V'INSTANCE_NAME));
      assert FALSE
      report Message.all
...
--        SIM_MODE => SIM_MODE,
      ...
      port map (
        ...
        AEN_SDMDATA0         => AEN_SDMDATA0_BIN,
        AEN_SDMDATA1         => AEN_SDMDATA1_BIN,
        AEN_SDMRESET0        => AEN_SDMRESET0_BIN,
        AEN_SDMRESET1        => AEN_SDMRESET1_BIN,
        AEN_SDMWIDTH0        => AEN_SDMWIDTH0_BIN,
        AEN_SDMWIDTH1        => AEN_SDMWIDTH1_BIN,
        ...
        A_SDM0DATA1_0        => A_SDM0DATA1_0_BIN,
        A_SDM0DATA1_1        => A_SDM0DATA1_1_BIN,
        A_SDM1DATA1_0        => A_SDM1DATA1_0_BIN,
        A_SDM1DATA1_1        => A_SDM1DATA1_1_BIN,
        A_SDMRESET0          => A_SDMRESET0_BIN,
        A_SDMRESET1          => A_SDMRESET1_BIN,
