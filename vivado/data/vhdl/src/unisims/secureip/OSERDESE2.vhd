...
use unisim.vpkg.all;
  ...
  architecture OSERDESE2_V of OSERDESE2 is
    ...
    signal IS_CLKDIV_INVERTED_BIN : std_ulogic;
    signal IS_CLK_INVERTED_BIN : std_ulogic;
    signal IS_D1_INVERTED_BIN : std_ulogic;
    signal IS_D2_INVERTED_BIN : std_ulogic;
    signal IS_D3_INVERTED_BIN : std_ulogic;
    signal IS_D4_INVERTED_BIN : std_ulogic;
    signal IS_D5_INVERTED_BIN : std_ulogic;
    signal IS_D6_INVERTED_BIN : std_ulogic;
    signal IS_D7_INVERTED_BIN : std_ulogic;
    signal IS_D8_INVERTED_BIN : std_ulogic;
    signal IS_T1_INVERTED_BIN : std_ulogic;
    signal IS_T2_INVERTED_BIN : std_ulogic;
    signal IS_T3_INVERTED_BIN : std_ulogic;
    signal IS_T4_INVERTED_BIN : std_ulogic;
    ...
    CLKDIV_ipd <= CLKDIV xor IS_CLKDIV_INVERTED_BIN;
    CLK_ipd <= CLK xor IS_CLK_INVERTED_BIN;
    
    D1_ipd <= D1 xor IS_D1_INVERTED_BIN;
    D2_ipd <= D2 xor IS_D2_INVERTED_BIN;
    D3_ipd <= D3 xor IS_D3_INVERTED_BIN;
    D4_ipd <= D4 xor IS_D4_INVERTED_BIN;
    D5_ipd <= D5 xor IS_D5_INVERTED_BIN;
    D6_ipd <= D6 xor IS_D6_INVERTED_BIN;
    D7_ipd <= D7 xor IS_D7_INVERTED_BIN;
    D8_ipd <= D8 xor IS_D8_INVERTED_BIN;
    OCE_ipd <= OCE;
    RST_ipd <= RST;
    SHIFTIN1_ipd <= SHIFTIN1;
    SHIFTIN2_ipd <= SHIFTIN2;
    T1_ipd <= T1 xor IS_T1_INVERTED_BIN;
    T2_ipd <= T2 xor IS_T2_INVERTED_BIN;
    T3_ipd <= T3 xor IS_T3_INVERTED_BIN;
    T4_ipd <= T4 xor IS_T4_INVERTED_BIN;
    TBYTEIN_ipd <= TBYTEIN;
    TCE_ipd <= TCE;

    IS_CLKDIV_INVERTED_BIN <= TO_X01(IS_CLKDIV_INVERTED);
    ...
    IS_D3_INVERTED_BIN <= TO_X01(IS_D3_INVERTED);
    IS_D4_INVERTED_BIN <= TO_X01(IS_D4_INVERTED);
    IS_D5_INVERTED_BIN <= TO_X01(IS_D5_INVERTED);
    IS_D6_INVERTED_BIN <= TO_X01(IS_D6_INVERTED);
    IS_D7_INVERTED_BIN <= TO_X01(IS_D7_INVERTED);
    IS_D8_INVERTED_BIN <= TO_X01(IS_D8_INVERTED);
    IS_T1_INVERTED_BIN <= TO_X01(IS_T1_INVERTED);
    IS_T2_INVERTED_BIN <= TO_X01(IS_T2_INVERTED);
    IS_T3_INVERTED_BIN <= TO_X01(IS_T3_INVERTED);
    IS_T4_INVERTED_BIN <= TO_X01(IS_T4_INVERTED);
