...
use unisim.vpkg.all;
  ...
  architecture ISERDESE2_V of ISERDESE2 is
    ...
    signal IS_CLKB_INVERTED_BIN : std_ulogic;
    signal IS_CLK_INVERTED_BIN : std_ulogic;
    signal IS_CLKDIVP_INVERTED_BIN : std_ulogic;
    signal IS_CLKDIV_INVERTED_BIN : std_ulogic;
    signal IS_OCLK_INVERTED_BIN : std_ulogic;
    signal IS_OCLKB_INVERTED_BIN : std_ulogic;
    signal IS_D_INVERTED_BIN : std_ulogic;

    
    begin
    IS_CLKB_INVERTED_BIN <= TO_X01(IS_CLKB_INVERTED);
    IS_CLK_INVERTED_BIN <= TO_X01(IS_CLK_INVERTED);
    IS_CLKDIV_INVERTED_BIN <= TO_X01(IS_CLKDIV_INVERTED);
    IS_CLKDIVP_INVERTED_BIN <= TO_X01(IS_CLKDIVP_INVERTED);
    IS_OCLK_INVERTED_BIN <= TO_X01(IS_OCLK_INVERTED);
    IS_OCLKB_INVERTED_BIN <= TO_X01(IS_OCLKB_INVERTED);
    ...
    CLKB_ipd <= CLKB xor IS_CLKB_INVERTED_BIN;
    CLKDIVP_ipd <= CLKDIVP xor IS_CLKDIVP_INVERTED_BIN;
    CLKDIV_ipd <= CLKDIV xor IS_CLKDIV_INVERTED_BIN;
    CLK_ipd <= CLK xor IS_CLK_INVERTED_BIN;
    OCLKB_ipd <= OCLKB xor IS_OCLKB_INVERTED_BIN;
    OCLK_ipd <= OCLK xor IS_OCLK_INVERTED_BIN;
