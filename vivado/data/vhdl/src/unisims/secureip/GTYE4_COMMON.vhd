...
architecture GTYE4_COMMON_V of GTYE4_COMMON is
  component SIP_GTYE4_COMMON
    port (
      ...
      UB_CFG0              : in std_logic_vector(15 downto 0);
      UB_CFG1              : in std_logic_vector(15 downto 0);
      UB_CFG2              : in std_logic_vector(15 downto 0);
      UB_CFG3              : in std_logic_vector(15 downto 0);
      UB_CFG4              : in std_logic_vector(15 downto 0);
      UB_CFG5              : in std_logic_vector(15 downto 0);
      UB_CFG6              : in std_logic_vector(15 downto 0);
      ...
      PMARSVDOUT0          : out std_logic_vector(7 downto 0);
      PMARSVDOUT1          : out std_logic_vector(7 downto 0);
      PMASCANOUT           : out std_logic_vector(13 downto 0);
      QPLL0FBCLKLOST       : out std_ulogic;
      QPLL0LOCK            : out std_ulogic;
      QPLL0OUTCLK          : out std_ulogic;
      QPLL0OUTREFCLK       : out std_ulogic;
      ...
      PMARSVD0             : in std_logic_vector(7 downto 0);
      PMARSVD1             : in std_logic_vector(7 downto 0);
      PMASCANCLK           : in std_logic_vector(13 downto 0);
      PMASCANENB           : in std_ulogic;
      PMASCANIN            : in std_logic_vector(13 downto 0);
  ...
  constant MODULE_NAME : string := "GTYE4_COMMON";
  ...
  constant UB_CFG0_BIN : std_logic_vector(15 downto 0) := UB_CFG0;
  constant UB_CFG1_BIN : std_logic_vector(15 downto 0) := UB_CFG1;
  constant UB_CFG2_BIN : std_logic_vector(15 downto 0) := UB_CFG2;
  constant UB_CFG3_BIN : std_logic_vector(15 downto 0) := UB_CFG3;
  constant UB_CFG4_BIN : std_logic_vector(15 downto 0) := UB_CFG4;
  constant UB_CFG5_BIN : std_logic_vector(15 downto 0) := UB_CFG5;
  constant UB_CFG6_BIN : std_logic_vector(15 downto 0) := UB_CFG6;
...
-- Parameter encodings and registers
  ...
  signal PMASCANOUT_out : std_logic_vector(13 downto 0);
  ...
  signal UBDADDR_out : std_logic_vector(15 downto 0);
  signal UBDEN_out : std_ulogic;
  signal UBDI_out : std_logic_vector(15 downto 0);
  signal UBDWE_out : std_ulogic;
  signal UBMDMTDO_out : std_ulogic;
  signal UBRSVDOUT_out : std_ulogic;
  signal UBTXUART_out : std_ulogic;
  ...
  signal PMASCANCLK_in : std_logic_vector(13 downto 0);
  signal PMASCANENB_in : std_ulogic;
  signal PMASCANIN_in : std_logic_vector(13 downto 0);
  ...
  signal UBCFGSTREAMEN_in : std_ulogic;
  signal UBDO_in : std_logic_vector(15 downto 0);
  signal UBDRDY_in : std_ulogic;
  signal UBENABLE_in : std_ulogic;
  signal UBGPI_in : std_logic_vector(1 downto 0);
  signal UBINTR_in : std_logic_vector(1 downto 0);
  signal UBIOLMBRST_in : std_ulogic;
  signal UBMBRST_in : std_ulogic;
  signal UBMDMCAPTURE_in : std_ulogic;
  signal UBMDMDBGRST_in : std_ulogic;
  signal UBMDMDBGUPDATE_in : std_ulogic;
  signal UBMDMREGEN_in : std_logic_vector(3 downto 0);
  signal UBMDMSHIFT_in : std_ulogic;
  signal UBMDMSYSRST_in : std_ulogic;
  signal UBMDMTCK_in : std_ulogic;
  signal UBMDMTDI_in : std_ulogic;
  ...
  UBCFGSTREAMEN_in <= '0' when (UBCFGSTREAMEN = 'U') else UBCFGSTREAMEN; -- rv 0
  UBDO_in(0) <= '0' when (UBDO(0) = 'U') else UBDO(0); -- rv 0
  UBDO_in(1) <= '0' when (UBDO(1) = 'U') else UBDO(1); -- rv 0
  UBDO_in(10) <= '0' when (UBDO(10) = 'U') else UBDO(10); -- rv 0
  UBDO_in(11) <= '0' when (UBDO(11) = 'U') else UBDO(11); -- rv 0
  UBDO_in(12) <= '0' when (UBDO(12) = 'U') else UBDO(12); -- rv 0
  UBDO_in(13) <= '0' when (UBDO(13) = 'U') else UBDO(13); -- rv 0
  UBDO_in(14) <= '0' when (UBDO(14) = 'U') else UBDO(14); -- rv 0
  UBDO_in(15) <= '0' when (UBDO(15) = 'U') else UBDO(15); -- rv 0
  UBDO_in(2) <= '0' when (UBDO(2) = 'U') else UBDO(2); -- rv 0
  UBDO_in(3) <= '0' when (UBDO(3) = 'U') else UBDO(3); -- rv 0
  UBDO_in(4) <= '0' when (UBDO(4) = 'U') else UBDO(4); -- rv 0
  UBDO_in(5) <= '0' when (UBDO(5) = 'U') else UBDO(5); -- rv 0
  UBDO_in(6) <= '0' when (UBDO(6) = 'U') else UBDO(6); -- rv 0
  UBDO_in(7) <= '0' when (UBDO(7) = 'U') else UBDO(7); -- rv 0
  UBDO_in(8) <= '0' when (UBDO(8) = 'U') else UBDO(8); -- rv 0
  UBDO_in(9) <= '0' when (UBDO(9) = 'U') else UBDO(9); -- rv 0
  UBDRDY_in <= '0' when (UBDRDY = 'U') else UBDRDY; -- rv 0
  UBENABLE_in <= '0' when (UBENABLE = 'U') else UBENABLE; -- rv 0
  UBGPI_in(0) <= '0' when (UBGPI(0) = 'U') else UBGPI(0); -- rv 0
  UBGPI_in(1) <= '0' when (UBGPI(1) = 'U') else UBGPI(1); -- rv 0
  UBINTR_in(0) <= '0' when (UBINTR(0) = 'U') else UBINTR(0); -- rv 0
  UBINTR_in(1) <= '0' when (UBINTR(1) = 'U') else UBINTR(1); -- rv 0
  UBIOLMBRST_in <= '1' when (UBIOLMBRST = 'U') else UBIOLMBRST; -- rv 1
  UBMBRST_in <= '1' when (UBMBRST = 'U') else UBMBRST; -- rv 1
  UBMDMCAPTURE_in <= '0' when (UBMDMCAPTURE = 'U') else UBMDMCAPTURE; -- rv 0
  UBMDMDBGRST_in <= '0' when (UBMDMDBGRST = 'U') else UBMDMDBGRST; -- rv 0
  UBMDMDBGUPDATE_in <= '0' when (UBMDMDBGUPDATE = 'U') else UBMDMDBGUPDATE; -- rv 0
  UBMDMREGEN_in(0) <= '0' when (UBMDMREGEN(0) = 'U') else UBMDMREGEN(0); -- rv 0
  UBMDMREGEN_in(1) <= '0' when (UBMDMREGEN(1) = 'U') else UBMDMREGEN(1); -- rv 0
  UBMDMREGEN_in(2) <= '0' when (UBMDMREGEN(2) = 'U') else UBMDMREGEN(2); -- rv 0
  UBMDMREGEN_in(3) <= '0' when (UBMDMREGEN(3) = 'U') else UBMDMREGEN(3); -- rv 0
  UBMDMSHIFT_in <= '0' when (UBMDMSHIFT = 'U') else UBMDMSHIFT; -- rv 0
  UBMDMSYSRST_in <= '0' when (UBMDMSYSRST = 'U') else UBMDMSYSRST; -- rv 0
  UBMDMTCK_in <= '0' when (UBMDMTCK = 'U') else UBMDMTCK; -- rv 0
  UBMDMTDI_in <= '0' when (UBMDMTDI = 'U') else UBMDMTDI; -- rv 0
  

  PMASCANCLK_in <= "11111111111111"; -- tie off

  CSSDSTOPCLK0_in <= '1'; -- tie off
  CSSDSTOPCLK1_in <= '1'; -- tie off
  PMASCANENB_in <= '1'; -- tie off
  PMASCANIN_in <= "11111111111111"; -- tie off
  ...
  begin
    -------- QPLL0CLKOUT_RATE check
      if((xil_attr_test) or
        ...
        Write ( Message, string'(GTYE4_COMMON_V'PATH_NAME));
