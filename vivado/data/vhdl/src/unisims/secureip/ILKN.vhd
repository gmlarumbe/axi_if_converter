...
architecture ILKN_V of ILKN is
  ...
  -- Parameter encodings and registers
    ...
    signal RX_OVFOUT_out : std_logic;
    ...
    signal STAT_RX_BURSTMAX_ERR_out : std_logic;
    signal STAT_RX_BURST_ERR_out : std_logic;
    signal STAT_RX_CRC24_ERR_out : std_logic;
    ...
    signal STAT_RX_MEOP_ERR_out : std_logic;
    ...
    signal STAT_RX_MSOP_ERR_out : std_logic;
    signal STAT_RX_MUBITS_UPDATED_out : std_logic;
    signal STAT_RX_MUBITS_out : std_logic_vector(7 downto 0);
    signal STAT_RX_OVERFLOW_ERR_out : std_logic;
    signal STAT_RX_RETRANS_CRC24_ERR_out : std_logic;
    signal STAT_RX_RETRANS_DISC_out : std_logic;
    signal STAT_RX_RETRANS_LATENCY_out : std_logic_vector(15 downto 0);
    signal STAT_RX_RETRANS_REQ_out : std_logic;
    signal STAT_RX_RETRANS_RETRY_ERR_out : std_logic;
    signal STAT_RX_RETRANS_SEQ_UPDATED_out : std_logic;
    ...
    signal STAT_RX_RETRANS_WDOG_ERR_out : std_logic;
    signal STAT_RX_RETRANS_WRAP_ERR_out : std_logic;
    ...
    signal STAT_TX_BURST_ERR_out : std_logic;
    signal STAT_TX_ERRINJ_BITERR_DONE_out : std_logic;
    signal STAT_TX_OVERFLOW_ERR_out : std_logic;
    signal STAT_TX_RETRANS_BURST_ERR_out : std_logic;
    signal STAT_TX_RETRANS_BUSY_out : std_logic;
    signal STAT_TX_RETRANS_RAM_PERROUT_out : std_logic;
    signal STAT_TX_RETRANS_RAM_RADDR_out : std_logic_vector(8 downto 0);
    signal STAT_TX_RETRANS_RAM_RD_B0_out : std_logic;
    signal STAT_TX_RETRANS_RAM_RD_B1_out : std_logic;
    signal STAT_TX_RETRANS_RAM_RD_B2_out : std_logic;
    signal STAT_TX_RETRANS_RAM_RD_B3_out : std_logic;
    ...
    signal STAT_TX_RETRANS_RAM_WE_B0_out : std_logic;
    signal STAT_TX_RETRANS_RAM_WE_B1_out : std_logic;
    signal STAT_TX_RETRANS_RAM_WE_B2_out : std_logic;
    signal STAT_TX_RETRANS_RAM_WE_B3_out : std_logic;
    signal STAT_TX_UNDERFLOW_ERR_out : std_logic;
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-126] TEST_MODE_PIN_CHAR attribute is set to """));
    ...
    if  (attr_err) then
      ...
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-127] Attribute Error(s) encountered. "));
      Write ( Message, string'("Instance "));
      Write ( Message, string'(ILKN_V'INSTANCE_NAME));
      assert FALSE
      report Message.all
  ...
  ES2_ILKN_inst : if (SIM_VERSION = "2.0") generate
    ILKN_INST : SIP_ILKN_ES2
       port map (
        BYPASS               => BYPASS_BIN,
   ...
   end generate ES2_ILKN_inst;

  ES1_ILKN_inst : if (SIM_VERSION = "1.0") generate
    ILKN_INST : SIP_ILKN
      port map (
        BYPASS               => BYPASS_BIN,
        CTL_RX_BURSTMAX      => CTL_RX_BURSTMAX_BIN,
